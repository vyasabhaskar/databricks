...
def customers_bronze_cdc():
    ...
    country_lookup_df = spark.read.json("dbfs:/Volumes/workspace/bookstore_eng_pro/dataset/country_lookup/")
...
dp.create_streaming_table("customers_silver_df")

dp.create_auto_cdc_flow(
  target = "customers_silver_df",
...
def countries_stats():
  ...
  customers_df = spark.read.table("customers_silver_df")
